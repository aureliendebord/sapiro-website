...
SAPIRO, QuizUp and HQ Trivia are three very different approaches to quizzes. Here are the important distinctions to choose.

## QuizUp: real-time duels

**The concept.** Duel face-off on a specific theme. 7 questions each, 10 seconds per question. Ranking system by category and country.

**Strengths.** Very addictive. Pure competition. Over 500 categories (movies, sports, geography, history).
...
**The concept.** Live show at fixed times (often 9pm). All players play the same questions at the same time. One wrong answer = elimination. The survivor(s) share a real cash pot.
...
| Criteria | QuizUp | HQ Trivia | SAPIRO |
|----------|--------|-----------|--------|
...
That is the fundamental philosophical difference. QuizUp and HQ Trivia are competitive games where the quiz is a pretext. SAPIRO is a learning tool where the quiz is a means.

Neither is better than the other, they meet different needs.
