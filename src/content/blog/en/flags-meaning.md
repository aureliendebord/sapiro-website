...
## The Universal Language of Flag Colors

While every flag tells its own story, certain colors show up so often that they have developed near-universal associations.
...
Yellow or gold symbolizes wealth, the sun, generosity, or justice. It appears prominently in the flags of Colombia, Spain, and many African nations whose economies historically depended on gold or other natural resources.

Understanding these color codes is the first step to reading any flag in the world. But the real richness lies in how individual nations combine them.

## What do the stars, crescents, and crosses on flags mean?

Beyond colors, flags rely on recurring symbols that carry deep meaning.

Stars are among the most popular flag elements. They can represent states or provinces (the 50 stars on the U.S. flag), unity (the single star on flags like Vietnam and Somalia), or guidance and aspiration. The Southern Cross constellation appears on the flags of Australia, New Zealand, Brazil, and Papua New Guinea, anchoring those nations to their place in the Southern Hemisphere sky.
...
Crosses mark the flags of many nations with Christian heritage. The Scandinavian cross -- off-center, extending to the edges of the flag -- unites Denmark, Sweden, Norway, Finland, and Iceland in a shared design tradition dating back to the 13th century. These flags make a great exercise when [teaching geography to kids](/en/blog/geographie-enfants). Switzerland and Georgia use centered crosses, while the United Kingdom's Union Jack famously overlays the crosses of Saint George, Saint Andrew, and Saint Patrick.
...
If you enjoy discovering these kinds of details, you might also like our article on [the 12 most common geography mistakes](/en/blog/erreurs-geographie), which reveals how often we get basic facts about countries wrong.
...
## Brazil: Order and Progress Written in the Sky
...
## Why is Nepal the only country with a non-rectangular flag?

Every other flag on this list follows the standard rectangular format. Nepal's does not. The Nepali flag consists of two stacked triangular pennants, making it the only national flag in the world that is not rectangular. The crimson red represents bravery (and is also the color of the national flower, the rhododendron), while the blue border signifies peace and harmony.

The upper triangle contains a white moon. The lower triangle holds a white sun. Together, they express the hope that Nepal will last as long as these celestial bodies. The shapes also echo the peaks of the Himalayas, which define Nepal's landscape and identity.
...
For a broader look at how countries are often confused or misunderstood, check out our piece on [the 12 most common geography mistakes everyone makes](/en/blog/erreurs-geographie).
...
These near-twins are a perennial source of embarrassment at international sporting events, where the wrong flag occasionally appears on scoreboards. Sometimes it takes a formal protest to get it corrected. Our deep dive into [the 15 hardest flags to recognize](/en/blog/drapeaux-difficiles) covers even more confusing pairs and the tricks to finally tell them apart.

## Frequently asked questions

### What is the most common color on national flags?

Red is the most common, appearing on roughly 74% of the world's 195 national flags. White and blue follow closely behind. These three colors dominate because of their strong associations with sacrifice, peace, and freedom.

### Which country has the oldest flag in the world?

Denmark's flag, the Dannebrog, is the oldest continuously used national flag, dating back to 1219 according to Danish tradition. It features a white Scandinavian cross on a red background.

### Why do so many flags have stars on them?

Stars typically represent states or provinces (as on the U.S. flag), unity and independence (single stars on flags like Vietnam and Somalia), or geographic position (the Southern Cross on Australian and New Zealand flags). About 60 national flags feature at least one star.
