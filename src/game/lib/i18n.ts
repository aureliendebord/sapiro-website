...
const WEB_STRINGS: Record<GameLang, Dict> = {
  fr: {
    ...
    result: {
      ...
      bonusSurvival: "Belle survie",
      bonusSurvivalComplete: "Pool épuisé",
      bonusSurvivalPerfect: "Survie parfaite",
  ...
  en: {
    home: {
      ...
      journeysMeta: "54 blocks · progress",
      ...
      classicMeta: "10 questions · 1 game",
      survival: "Survival",
      survivalDesc: "3 lives, how far can you go?",
      survivalMeta: "3 lives · endless",
      review: "Review",
      reviewDesc: "Replay what you missed.",
      reviewMeta: "Your mistakes",
  ...
  es: {
    ...
    result: {
      ...
      bonusSurvivalPerfect: "Supervivencia perfecta",
