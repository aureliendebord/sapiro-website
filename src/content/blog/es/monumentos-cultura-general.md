---
title: "Repasar los monumentos para oposiciones y selectividad"
...
readingTime: 7
faqItems:
  - question: "¿Qué monumentos caen más a menudo en las oposiciones?"
    answer: "Los grandes referentes mundiales y europeos: la Torre Eiffel, el Coliseo, el Taj Mahal, la Gran Muralla, las pirámides de Guiza, y monumentos españoles como la Alhambra o la Sagrada Família. A los test les gusta asociar cada uno con un país, una ciudad, un siglo o un estilo arquitectónico."
  - question: "¿Hay que saberse las siete maravillas del mundo de memoria?"
    answer: "Sí, las dos listas. Las siete maravillas antiguas (de las que solo queda en pie la pirámide de Keops) aparecen con frecuencia, y la lista moderna elegida en 2007 es la base de muchas preguntas de cultura general."
  - question: "¿Cómo no confundir la Alhambra con la Mezquita de Córdoba?"
    answer: "La Alhambra es un conjunto palaciego nazarí en Granada, de los siglos XIII y XIV. La Mezquita-Catedral de Córdoba es un templo de origen omeya, con su famoso bosque de arcos rojos y blancos, varios siglos anterior. Ciudad, función y época las separan por completo."
  - question: "¿Cuánto tiempo se tarda en repasar los monumentos?"
    answer: "Bastan unas semanas si repasas en sesiones cortas y espaciadas en lugar de atracones. Una ficha por país o por época, releída a intervalos crecientes y puesta a prueba con cuestionarios, fija lo esencial sin robarte tardes enteras."
---
...
Para ampliar, nuestro [dossier sobre monumentos](/es/monumentos/) y nuestra selección de [30 monumentos famosos del mundo](/es/blog/monumentos-famosos-mundo/) cubren estos referentes en detalle, y nuestra guía de las [maravillas del mundo](/es/blog/maravillas-del-mundo/) repasa ambas listas.
...
Para entrenarte a cazar estas trampas, el [cuestionario de monumentos del mundo](/es/blog/quiz-monumentos-mundo/) se construye precisamente sobre estas confusiones.
...
**Ponte a prueba de forma activa.** Releer da la ilusión de saber. Preguntarse revela lo que de verdad se ignora. Tapa la respuesta, sitúa el monumento y luego comprueba. Los [cuestionarios de cultura general de SAPIRO](/es/quiz/) convierten estas listas en partidas cortas y ayudan a detectar los huecos antes del examen.
