...
Del pueblo *Rus*, vikingos venidos de Suecia que fundaron [Kiev](https://es.wikipedia.org/wiki/Rus_de_Kiev) en el siglo IX. Su nombre vendría del finés *Ruotsi* que designa a Suecia (tierra de remeros).
...
"Estados Unidos de América". América viene de [Amerigo Vespucci](https://es.wikipedia.org/wiki/Am%C3%A9rico_Vespucio), navegante italiano que afirmó primero en 1502 que el Nuevo Mundo no era Asia sino un nuevo continente.
