...
Memory trick: Slova-K-ia ends in "K", so think "K for east of ChecK republic." Slove-N-ia has an "N", so think "N for Next to Italy."
...
Two Eastern European capitals starting with "Bu", a recipe for confusion. Budapest is the capital of Hungary, a city split by the Danube into Buda (the hilly west side) and Pest (the flat east side). Bucharest is the capital of Romania, located further east on the Wallachian Plain. About 800 kilometers separate the two.

Memory trick: Budapest has a "P", so think "P for Pest, the flat side on the Danube." Bucharest has an "R", so think "R for Romania."
