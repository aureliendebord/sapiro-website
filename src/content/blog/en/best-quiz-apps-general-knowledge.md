...
The app is primarily French-language, which limits its audience. The Elo system is genuinely motivating if you're competitive, but there are no thematic learning paths, so your knowledge gains end up scattered rather than building toward anything. The interface is functional but feels like it hasn't been updated in a while. Ads throughout.
